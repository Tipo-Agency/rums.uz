...
export function BabyjoyInquiryModal({ isOpen, onClose, variant = 'default' }: BabyjoyInquiryModalProps) {
  ...
  useEffect(() => {
    if (isOpen) {
      trackModalOpen(variant, 'babyjoy');
    }
            ...
            <div className="mt-6 text-center">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    onClick={() => {
                      trackCustomEvent('Contact', { method: 'telegram', source: 'babyjoy' });
                      window.open(`https://t.me/babyjoy_uz?text=${encodeURIComponent(t('modalTelegramMessageBabyjoy'))}`, '_blank');
                    }}
                  >
                  ...
                  <Button
                    ...
                    className="bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100"
                    onClick={() => {
                      trackCustomEvent('Contact', { method: 'phone', source: 'babyjoy' });
